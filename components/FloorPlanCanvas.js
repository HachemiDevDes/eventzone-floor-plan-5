...
const FloorPlanCanvas = React.forwardRef(({
  ...
  const renderElement = (el) => {
    ...
    const checkFilterMatch = (el, filter) => {
      ...
      if (filter === "sold") return el.status === "sold" && el.type.startsWith("booth");
      ...
      if (filter === "confirmed") return el.status === "confirmed" && el.type.startsWith("booth");
