...
const filterOptions = [
  ...
  { value: "confirmed", label: "Confirmed Booths", icon: CheckCircle2, iconColor: "text-teal-500" },
    ...
    const allMatched = elements.filter(el => {
      ...
      if (previewFilter && previewFilter !== "all") {
        const matchesFilter = (() => {
          ...
          if (previewFilter === "sold") return el.status === "sold" && el.type.startsWith("booth");
          ...
          if (previewFilter === "confirmed") return el.status === "confirmed" && el.type.startsWith("booth");
...
return (
    <div className={`flex flex-col flex-1 bg-slate-50 select-none ${
      initialPreviewMode 
        ? "h-screen w-full border-none rounded-none shadow-none overflow-hidden" 
        : "h-[calc(100vh-32px)] border border-slate-200 rounded-3xl shadow-sm overflow-hidden"
    }`}>
      <header className={`border-b border-slate-200 bg-white flex ${
        initialPreviewMode 
            ...
            <div className="flex-1 relative overflow-hidden flex flex-col w-full h-full">
              ...
              {isPreviewMode && previewDeviceMode === "mobile" && (
                <button
                  ...
                  className="absolute bottom-5 left-4 bg-indigo-650 hover:bg-indigo-700 text-white font-bold text-[11px] py-2.5 px-4 rounded-full shadow-lg flex items-center gap-1.5 z-40 cursor-pointer transition-transform hover:scale-105 active:scale-95"
                >
                  <Users size={12} />
                  <span>Directory</span>
                </button>
              ...
              <AnimatePresence>
                {isPreviewMode && previewDeviceMode === "mobile" && isMobileDirectoryOpen && (
                  <motion.div
                    ...
                    className="absolute inset-x-0 bottom-0 bg-white rounded-t-[30px] shadow-2xl border-t border-slate-200/80 z-50 flex flex-col max-h-[80%] pb-6 pointer-events-auto"
                  >
                    ...
                    <div className="flex-1 overflow-y-auto px-5 pr-4 flex flex-col gap-2">
                ...
                {isPreviewMode && previewDeviceMode === "mobile" && selectedIds.length === 1 && (() => {
                  ...
                  return (
                    <motion.div
                      ...
                      exit={{ y: "100%" }}
                      transition={{ type: "spring", damping: 25, stiffness: 220 }}
                      className="absolute inset-x-0 bottom-0 bg-white rounded-t-[30px] shadow-2xl border-t border-slate-200/80 z-50 flex flex-col max-h-[75%] pb-6 pointer-events-auto"
                    >
                      {/* Drag Handle */}
                            ...
                            <div className="flex items-center gap-2">
                              {(() => {
                                ...
                                if (status === "reserved") {
                                  ...
                                  bg = "bg-blue-50 text-blue-700 border border-blue-250";
                                  label = "Confirmed";
